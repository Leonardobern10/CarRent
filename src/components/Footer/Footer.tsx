...
export default function Footer(): ReactElement {
  return (
    <div className="col-span-7 row-span-2 md:row-span-1 flex flex-col md:flex-row justify-between items-center bg-black-medium md:border-t-2 md:border-t-white max-md:gap-y-7">
      ...
      <div className="h-1/2 flex flex-col items-center gap-y-5">

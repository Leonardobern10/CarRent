...
export default function AboutUs(): ReactElement {
  return (
    <section className="flex flex-col justify-around md:justify-center h-full w-full max-md:bg-black-medium row-span-7 md:row-span-5 col-span-7 md:col-start-2 md:col-end-7">

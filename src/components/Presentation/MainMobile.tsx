...
export default function MainMobile(props: {
  ...
  return (
    <motion.main
      ...
      className="flex flex-col justify-between items-center h-full mt-20 font-montserrat bg-[url(src/assets/images/main_car.png)] bg-blend-hard-light bg-cover bg-center bg-no-repeat"
    >

...
export default function PremiumServices(): ReactElement {
  return (
    <section className="font-poppins col-span-7 row-span-14 md:row-span-5 flex flex-col justify-evenly pt-5 items-center md:gap-y-5 md:bg-linear-to-b md:to-70% md:to-black-white md:from-70% md:from-black-medium max-md:bg-black-medium">

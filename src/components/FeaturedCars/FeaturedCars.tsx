...
export default function FeaturedCars(props: {
  ...
  return (
    <div className="col-start-2 col-end-7 place-self-center row-span-4 lg:row-span-6 flex flex-col items-center w-[90%] lg:w-full h-full max-lg:justify-evenly gap-y-0 lg:gap-y-10">

...
export default function ContactUs(): ReactElement {
  return (
    <section className="row-span-3 md:row-span-5 col-span-7 md:bg-linear-to-t md:from-60% md:from-black-medium md:to-60% md:to-white-background flex flex-col gap-y-4 justify-evenly items-center font-poppins">
